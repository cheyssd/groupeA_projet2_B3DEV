  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-3 mt-2">
        <button onClick={onClose} className="flex-1 py-3 rounded-xl text-xs tracking-[2px] uppercase font-semibold cursor-pointer transition-all"
        ...
        <button onClick={() => onSubmit(form)} disabled={loading}
          className="flex-1 py-3 rounded-xl text-xs tracking-[2px] uppercase font-semibold cursor-pointer transition-all"
            ...
            {loading ? (
              ...
              spaces.map((space, i) => (
                <div key={space.id}
                  ...
                  {/* Nom */}
                  <div>
                    <p className="font-bold text-sm" style={{ color: "var(--text-primary)", fontFamily: "'Barlow Condensed', sans-serif" }}>
                      {space.name}
                    </p>
