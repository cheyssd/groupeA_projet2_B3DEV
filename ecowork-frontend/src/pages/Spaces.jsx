  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen" style={{ background: "var(--bg-primary)", fontFamily: "'Barlow', sans-serif" }}>
        ...
        >
          <span
            className="font-black text-lg uppercase cursor-pointer"
          ...
          <div className="flex items-center gap-8">
            {["SPACES", "MEMBERSHIPS", "ACCOUNT"].map((item) => (
              <span
                key={item}
                className="text-xs tracking-[2px] uppercase cursor-pointer transition-colors"
                style={{
        ...
        {/* ── SEARCH BAR ── */}
        <div className="px-12 pt-10 pb-8 border-b" style={{ borderColor: "var(--border-color)" }}>
          <p
          ...
          <div className="flex items-center gap-4">
            <input
              ...
              placeholder="Entrez une ville, un quartier ou un mot-clé..."
            ...
            />
            <button
              className="w-12 h-12 rounded-full flex items-center justify-center flex-shrink-0 cursor-pointer transition-opacity hover:opacity-80"
              style={{ background: "var(--text-primary)" }}
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--bg-primary)" strokeWidth="2.5">
        ...
        <div className="flex px-12 py-8 gap-10">
          ...
          <div className="w-48 flex-shrink-0">
            ...
            <div className="mb-8">
              <p
                className="text-[9px] tracking-[3px] uppercase mb-4 font-semibold"
                style={{ fontFamily: "'Rajdhani', sans-serif", color: "var(--text-muted)" }}
              >
                Type d'espace
              </p>
          ...
          <div className="flex-1">
            ...
            {loading ? (
              ...
              <p
                ...
                style={{ color: "var(--text-muted)", fontFamily: "'Barlow', sans-serif" }}
              >
                ...
                {filtered.map((space, index) => (
                  ...
                  >
                    ...
                    <div className="relative rounded-2xl overflow-hidden mb-4" style={{ height: "260px" }}>
                      ...
                      {space.is_active === 1 && (
                        <div
                          className="absolute bottom-3 left-3 px-3 py-1 rounded-full text-[9px] tracking-[2px] uppercase font-semibold"
                          style={{
                            fontFamily: "'Rajdhani', sans-serif",
        ...
        {/* ── FOOTER ── */}
        <div
          className="flex items-center justify-between px-12 py-4 mt-8 border-t"
          style={{ borderColor: "var(--border-color)" }}
        >
          <span
